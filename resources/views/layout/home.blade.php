...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8">
        <title>Website Xương Rồng</title>
        <meta content="width=device-width, initial-scale=1.0" name="viewport">
        <meta content="" name="keywords">
        <meta content="" name="description">
        <base href="{{ asset('public/') }}"><!--Them vao 1-->
        ...
        <div class="container-fluid fixed-top">
            <div class="container topbar bg-primary d-none d-lg-block">
                <div class="d-flex justify-content-between">
                    <div class="top-info ps-2">
                        <small class="me-3"><i class="fas fa-map-marker-alt me-2 text-secondary"></i> <a href="#" class="text-white">109/19B, Cần Giuộc, Tây Ninh</a></small>
            ...
            <div class="container px-0">
                <nav class="navbar navbar-light bg-white navbar-expand-xl">
                    <a href="index.html" class="navbar-brand"><h1 class="text-primary display-6">Sen Rồng</h1></a>
                    ...
                    <div class="collapse navbar-collapse bg-white" id="navbarCollapse">
                        <div class="navbar-nav mx-auto">
                           ...
                           <a href="{{ route('home') }}" class="nav-item nav-link active">Trang Chủ</a>
                            ...
                            <a href="{{ route('customer') }}" class="nav-item nav-link">Customer</a>
                            <a href="{{ route('shop-detail') }}" class="nav-item nav-link">Chi Tiết Cửa Hàng</a>
                            <div class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu m-0 bg-secondary rounded-0">
                                    ...
                                    <a href="{{ route('testimonial') }}" class="dropdown-item">Lời Chứng Thực</a>
                                    <a href="{{ route('404') }}" class="dropdown-item">Trang Lỗi 404</a>
                                </div>
                            </div>
    ...
    <div class="container py-5">
        <div class="pb-4 mb-4" style="border-bottom: 1px solid rgba(226, 175, 24, 0.5);">
            <div class="row g-4">
                <div class="col-lg-3">
                    <a href="#">
                        <h1 class="text-primary mb-0">Vườn Cây Mini</h1>
                        <p class="text-secondary mb-0">Sen đá & Xương rồng chất lượng</p>
                    </a>
                </div>
                <div class="col-lg-6">
        ...
        <div class="row g-5">
            <div class="col-lg-3 col-md-6">
                <div class="footer-item">
                    <h4 class="text-light mb-3">Vì sao chọn chúng tôi</h4>
                    <p class="mb-4">Cây cảnh mini dễ chăm, giao hàng nhanh, hỗ trợ tận tình. Chúng tôi mang thiên nhiên đến gần bạn hơn mỗi ngày.</p>
            ...
            <div class="col-lg-3 col-md-6">
                <div class="d-flex flex-column text-start footer-item">
                    <h4 class="text-light mb-3">Tài khoản của bạn</h4>
                    <a class="btn-link" href="">Tài khoản</a>
                    <a class="btn-link" href="">Chi tiết đơn hàng</a>
                    <a class="btn-link" href="">Giỏ hàng</a>
                    <a class="btn-link" href="">Yêu thích</a>
            ...
            <div class="col-lg-3 col-md-6">
                <div class="footer-item">
                    ...
                    <p>Địa chỉ: 123 Đường Cây Cảnh, TP.HCM</p>
                    <p>Email: lienhe@vuoncaymini.vn</p>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
                <span class="text-light"><a href="#"><i class="fas fa-copyright text-light me-2"></i>Vườn Cây Mini</a> © 2025. Đã đăng ký bản quyền.</span>
            </div>
